...
server {
	...
	root /var/www/single-site-with-caching.com/public;
	...
	access_log /var/www/single-site-with-caching.com/logs/access.log;
	error_log /var/www/single-site-with-caching.com/logs/error.log;
	...
	location ~ \.php$ {
		...
		# Skip cache based on rules in global/server/performance/fastcgi-cache.conf.
